...
public class MapSmartAreActivity_ViewBinding implements Unbinder {
  private MapSmartAreActivity target;
  ...
  @UiThread
  public MapSmartAreActivity_ViewBinding(MapSmartAreActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public MapSmartAreActivity_ViewBinding(final MapSmartAreActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    MapSmartAreActivity target = this.target;
