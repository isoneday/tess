...
public class EditAlarmActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public EditAlarmActivity_ViewBinding(EditAlarmActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public EditAlarmActivity_ViewBinding(final EditAlarmActivity target, View source) {
    this.target = target;
    ...
    target.dayform = Utils.findRequiredViewAsType(source, R.id.dayform, "field 'dayform'", CardView.class);
  ...
  @CallSuper
  public void unbind() {
    EditAlarmActivity target = this.target;
