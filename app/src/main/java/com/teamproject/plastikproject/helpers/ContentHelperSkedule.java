 ...
 */
public class ContentHelperSkedule {
    ...
    public static List<Response> getPlaceList(Cursor cursor) {
        List<Response> places = new ArrayList<>();
        cursor.moveToFirst();
        while (!cursor.isAfterLast()) {
            ...
            Response placesModel = new Response(
                    cursor.getLong(indexId),
                    cursor.getString(indexName),
