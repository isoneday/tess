...
public class HalamanBaggingActivity extends SessionManager {
...
//    BottomNavigationView mBottomNavigationView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_halaman_bagging);
...
//                new DataLokasi.Listener<JSONArray>() {
//                    @Override
...
//                            TextSliderView textSliderView = new TextSliderView(HalamanBaggingActivity.this);
...
//                                    .setOnSliderClickListener(HalamanBaggingActivity.this);
//
        ...
        if (id == R.id.mn_logout) {
            ...
            modelUserCall.enqueue(new Callback<ModelUser>() {
                ...
                public void onResponse(Call<ModelUser> call, Response<ModelUser> response) {
                    ...
                    Intent intent = new Intent(HalamanBaggingActivity.this, LoginActivity.class);
...
//                        }
    ...
    public void onBackPressed() {
        AlertDialog.Builder alert = new AlertDialog.Builder(HalamanBaggingActivity.this);
        alert.setTitle("Exit");
