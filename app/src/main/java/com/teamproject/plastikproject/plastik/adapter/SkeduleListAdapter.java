package com.teamproject.plastikproject.plastik.adapter;
 ...
 */
public class SkeduleListAdapter extends CursorAdapter {
    private int resource;
    private LayoutInflater inflater;

    @TargetApi(8)
    public SkeduleListAdapter(Context context, Cursor c, int resource) {
        super(context, c);
    ...
    @TargetApi(11)
    public SkeduleListAdapter(Context context, Cursor c, int flags, int resource) {
