 ...
 */
public class SettingsSpinnerAdapterbar extends ArrayAdapter<PlacesModel> {
    private static final String TAG = SettingsSpinnerAdapterbar.class.getSimpleName();
    ...
    public SettingsSpinnerAdapterbar(Context context, int resource, List<PlacesModel> placesList, int resDefault) {
