 ...
 */
public class SettingstokoAdapter extends ArrayAdapter<Response> {
    private static final String TAG = SettingstokoAdapter.class.getSimpleName();
    private List<Response> placesList;
    private int resource, resDefault;
    private LayoutInflater inflater;
    private View.OnClickListener settingsClickListener;

    public SettingstokoAdapter(Context context, int resource, List<Response> placesList, int resDefault) {
